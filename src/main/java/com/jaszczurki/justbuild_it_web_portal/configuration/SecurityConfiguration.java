package com.jaszczurki.justbuild_it_web_portal.configuration;

import com.jaszczurki.justbuild_it_web_portal.repository.UserAuthRepository;
import com.jaszczurki.justbuild_it_web_portal.service.DatabaseUserDetailsService;
...
public class SecurityConfiguration {
    ...
    @Bean
    public UserDetailsService userDetailsService(UserAuthRepository userAuthRepository, BCryptPasswordEncoder passwordEncoder) {
        return new DatabaseUserDetailsService(userAuthRepository, passwordEncoder);
    }
